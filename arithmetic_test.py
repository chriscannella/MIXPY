...
test_machine.memory[1000].read([True, 0 , 150 % 64 ,150 /64, 2000 % 64, 2000 /64])
...
test_machine.memory[1000].read([False, 1,1,1,1,1])
...
test_machine.memory[1000].read([False, 1,1,1,1,2])
...
test_machine.memory[1000].read([True, 0,0,0,0, 2])
...
test_machine.memory[1000].read([False, 3,0,0,0,0])
...
test_machine.memory[1000].read([True, 0,2,0,0,0])
